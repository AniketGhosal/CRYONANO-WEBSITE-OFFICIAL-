        ...
        return (
          ...
          >
            ...
            <div className="w-full md:w-3/4 flex flex-col justify-center relative z-10">
              ...
              {tech.type === 'software' && tech.platforms && (
                <div>
                  <span className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 block">Integrated Fault Shutdown Protections</span>
                  <div className="flex flex-wrap gap-2">
                    {tech.platforms.map((p: string, pIdx: number) => (
                      <div key={pIdx} className="px-4 py-2 bg-[#0A2647] text-white rounded-md text-sm font-bold tracking-wide hover:bg-primary transition-colors cursor-default">
                        {p}
                      </div>
                    ))}
                  </div>
              ...
              {tech.type === 'protection' && tech.protects && (
                <div>
                  <span className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 block">Optimized For Research Environments</span>
                  <div className="flex flex-wrap gap-2">
                    {tech.protects.map((p: string, pIdx: number) => (
