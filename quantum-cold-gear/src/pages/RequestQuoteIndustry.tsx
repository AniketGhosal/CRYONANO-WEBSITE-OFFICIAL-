    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-primary/20 selection:text-primary overflow-x-hidden">
      ...
      <PageTransition>
        <main className="pt-[80px]">
          ...
          {/* ============================== */}
          {/* HERO SECTION - added top padding to separate from breadcrumb */}
          {/* ============================== */}
          ...
          <section className="container py-8 md:pb-12 pt-2">
            ...
            >
              {/* ====== SUCCESS MESSAGE - outside the faded wrapper, absolutely positioned ====== */}
              <AnimatePresence>
                {showSuccess && (
                  <motion.div
              ...
              >
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  {/* ============================== */}
                  {/* SUBMIT BUTTON - always visible but inactive when faded */}
                  {/* ============================== */}
                  <button
                    type="submit"
