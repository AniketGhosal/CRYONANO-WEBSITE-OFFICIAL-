...
//   Image, Gauge, Maximize2, Focus, Sun, Maximize
// } from "lucide-react";
...
//   Camera, Cpu, Focus, Eye, Maximize2, Sun, Activity, Zap, Shield, Layers, Target, Settings, Move, Waves
// };
...
//                     Delivering ultra-HD 4K imaging, apochromatic precision, and integrated measurement specifically optimized for {app.toLowerCase()} applications.
//                   </p>
//                 </motion.div>
//               )}
//             </AnimatePresence>
...
//   const icons = [Settings, Maximize2, Focus, Layers, Activity, Target, Camera, Sun];
...
//         <p className="text-sm text-slate-500 mt-1">Configure your microscope for specific research requirements</p>
//       </div>
...
// // MAIN PAGE COMPONENT
// // ==========================================
// export default function UltraClear4kPage() {
//   const product = productsData["ultraclear-4k"];
//   const [activeSection, setActiveSection] = useState("overview");
//   const [openAccordion, setOpenAccordion] = useState<string | null>("Optical Specifications");
...
const appDescriptions: Record<string, string> = {
  "Semiconductor Inspection": "High-resolution visualization of wafer surfaces, defects, and circuit microstructures.",
  "Materials Science": "Detailed morphological analysis and documentation of advanced materials.",
  "MEMS & Microsystems": "Precision inspection of micro-electromechanical systems and microfluidic channels.",
  "Electronics Manufacturing": "Quality control, soldering inspection, and PCB trace verification.",
  "Research Laboratories": "Versatile digital imaging platform for multi-disciplinary academic research.",
  "Quality Assurance": "Accurate metrology and defect documentation for industrial production lines."
};
...
const InteractiveControlHub = ({ technologies }: { technologies: any[] }) => {
  ...
  return (
    <div className="w-full bg-white rounded-3xl border border-border shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] overflow-hidden flex flex-col lg:flex-row mt-6">
      ...
      <div className="lg:w-1/3 bg-slate-50 border-r border-border p-6 flex flex-col gap-2">
        <div className="mb-6 pb-4 border-b border-slate-200">
          <p className="text-xs font-bold text-cyan-600 uppercase tracking-widest">Subsystem Diagnostics</p>
        </div>
        {technologies.map((tech) => (
          <button
            key={tech.id}
            onClick={() => setActiveTab(tech.id)}
            className={`text-left px-5 py-4 rounded-xl font-bold text-base transition-all duration-300 border-l-4 outline-none ${activeTab === tech.id ? 'bg-white border-primary text-[#0A2647] shadow-sm' : 'bg-transparent border-transparent text-slate-500 hover:bg-slate-100 hover:text-slate-700'}`}
          >
            {tech.subtitle}
          </button>
        ))}
      ...
      <div className="lg:w-2/3 p-8 lg:p-10 relative overflow-hidden bg-white">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-base text-slate-600 font-medium leading-relaxed mb-6">{activeTech.description}</p>
              ...
              <div>
                ...
                {activeTech.type === 'software' && activeTech.platforms && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {activeTech.platforms.map((p: string, idx: number) => (
                        <span key={idx} className="px-3 py-1.5 bg-[#0A2647] text-white text-sm font-bold rounded-lg">{p}</span>
                      ))}
                    </div>
                  </div>
                )}
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-2xl p-8 border border-border shadow-sm">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-extrabold text-[#0A2647] mt-3">Optional Enhancements</h3>
        <p className="text-base text-slate-500 mt-2">Configure your microscope for specific research requirements</p>
      </div>
      ...
      <div className="min-h-screen bg-background text-foreground antialiased selection:bg-primary selection:text-white relative">
        ...
        <section ref={overviewRef} className="py-16 bg-white border-b border-border">
          <div className="container max-w-5xl text-center">
            <motion.span 
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block"
            >
              System Profile
            </motion.span>
            <motion.h2 
        ...
        <section ref={featuresRef} className="py-16 bg-slate-50/30 border-b border-border">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block">High-Fidelity Engineering</span>
              <h2 className="font-display text-3xl lg:text-4xl font-extrabold text-[#0A2647]">Key Platform Capabilities</h2>
            </div>
        ...
        <section ref={techRef} className="py-16 bg-white border-b border-border">
          <div className="container max-w-6xl">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block">Technical Deep-Dive</span>
              <h2 className="font-display text-3xl lg:text-4xl font-extrabold text-[#0A2647]">Core Technologies</h2>
            </div>
        ...
        <section ref={specsRef} className="py-16 bg-slate-50/50 border-b border-border">
          <div className="container max-w-4xl">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
              <div>
                <span className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block">Data Sheet</span>
                <h2 className="font-display text-3xl lg:text-4xl font-extrabold text-[#0A2647]">Technical Specifications</h2>
              </div>
              <div className="flex gap-2">
                <button 
        ...
        <section ref={appsRef} className="py-16 bg-slate-50/30 border-b border-border">
          <div className="container">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block">Deployment Scenarios</span>
              <h2 className="font-display text-3xl lg:text-4xl font-extrabold text-[#0A2647]">Scientific & Industrial Applications</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {product.applications.map((app: string, i: number) => (
                ...
                >
                  ...
                  <p className="text-base text-slate-600 leading-relaxed flex-1">
                    {appDescriptions[app] || "Precision imaging and measurement for advanced research applications."}
                  </p>
                </motion.div>
              ))}
            </div>
        ...
        {product.gallery && product.gallery.length > 0 && (
          <section className="py-16 bg-white border-b border-border">
            <div className="container max-w-6xl">
              <div className="text-center max-w-3xl mx-auto mb-12">
                <span className="text-cyan-600 font-bold tracking-widest uppercase text-xs mb-2 block">System Imagery</span>
                <h2 className="font-display text-3xl lg:text-4xl font-extrabold text-[#0A2647]">Visual Reference</h2>
              </div>
