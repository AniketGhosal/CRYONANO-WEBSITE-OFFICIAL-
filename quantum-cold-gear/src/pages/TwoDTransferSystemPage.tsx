  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-white border border-border rounded-xl p-6 shadow-sm hover:shadow-md hover:border-primary transition-all group">
        ...
        <p className="text-3xl font-extrabold text-[#0A2647]">±1 <span className="text-base font-bold text-slate-500">µm</span></p>
        <p className="text-sm text-slate-500 mt-1">Sub-micron positioning precision</p>
      </div>
      <div className="bg-white border border-border rounded-xl p-6 shadow-sm hover:shadow-md hover:border-primary transition-all group">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg bg-cyan-50 flex items-center justify-center text-cyan-600 group-hover:bg-primary group-hover:text-white transition-colors">
        ...
        <p className="text-3xl font-extrabold text-[#0A2647]">0.01<span className="text-base font-bold text-slate-500">°</span></p>
        <p className="text-sm text-slate-500 mt-1">Precise rotational control for twistronics</p>
      </div>
      <div className="bg-white border border-border rounded-xl p-6 shadow-sm hover:shadow-md hover:border-primary transition-all group">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center text-amber-600 group-hover:bg-primary group-hover:text-white transition-colors">
        ...
        <p className="text-3xl font-extrabold text-[#0A2647]">100<span className="text-base font-bold text-slate-500">°C</span></p>
        <p className="text-sm text-slate-500 mt-1">PID-controlled uniform heating</p>
      </div>
    </div>
  );
};
      ...
      <div className="min-h-screen bg-background text-foreground antialiased selection:bg-primary selection:text-white relative">
        ...
        <section ref={techRef} className="py-16 bg-white border-b border-border">
          <div className="container max-w-6xl">
            ...
            {/* Static Performance Metrics */}
            <div className="mt-12">
              <h3 className="text-center text-2xl font-extrabold text-[#0A2647] mb-8">Performance Metrics</h3>
              <PerformanceMetrics />
            </div>
          </div>
        </section>
