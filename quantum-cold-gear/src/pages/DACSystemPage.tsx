        ...
        return (
          ...
          >
            ...
            <div className="w-full md:w-1/4 flex flex-col items-center md:items-start text-center md:text-left shrink-0 border-b md:border-b-0 md:border-r border-slate-100 pb-4 md:pb-0 md:pr-4 relative z-10">
              ...
              <p className="text-xs font-extrabold text-slate-400 uppercase tracking-widest leading-normal group-hover:text-primary transition-colors">
                {tech.sideCaption}
              </p>
            </div>
            ...
            {/* Right Box: Text content area */}
            <div className="w-full md:w-3/4 flex flex-col justify-center relative z-10">
              <span className="text-xs font-bold text-primary tracking-wider uppercase mb-1 block">{tech.subtitle}</span>
              <h3 className="text-xl font-extrabold text-[#0A2647] mb-2 group-hover:text-primary transition-colors">{tech.title}</h3>
              ...
              {tech.type === 'software' && tech.platforms && (
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-2">Integrated Platforms</p>
                  <div className="flex flex-wrap gap-1.5">
                    {tech.platforms.map((p: string, pIdx: number) => (
                      <div key={pIdx} className="px-3 py-1 bg-[#0A2647] text-white rounded text-xs font-bold tracking-wide hover:bg-primary transition-colors cursor-default">
                        {p}
                      </div>
                    ))}
                  </div>
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-2xl p-8 border border-border shadow-sm">
      <div className="text-center mb-10">
        ...
        <p className="text-base text-slate-600 mt-2">Configure your DAQ system for specific research requirements</p>
      </div>
