...
//   Waves, Layers, Network, Lock, ShieldAlert, Code, ArrowLeft, ArrowRight, Move, Wind, Eye, Droplets, Orbit, Image, Box
// } from "lucide-react";
...
// const iconMap: Record<string, any> = { ThermometerSnowflake, Activity, Zap, Shield, ShieldCheck, Camera, Move, Waves, Target, Cpu, Settings, Layers, Code, Eye, Droplets, ShieldAlert, Network, Wind, Box };
...
// // MAIN PAGE COMPONENT
// // ==========================================
// export default function DcDcSystemPageLow() {
//   const product = productsData["dc-dc-system-low"];
//   const [activeSection, setActiveSection] = useState("overview");
//   const [openAccordion, setOpenAccordion] = useState<string | null>("Electrical Input");
...
//     if (token) {
//       // User is logged in! Trigger native PDF download.
...
//     } else {
//       // Not logged in -> Show the Auth Modal
      ...
      <div className="min-h-screen bg-background text-foreground antialiased selection:bg-primary selection:text-white relative">
        ...
        <div className="sticky top-[var(--nav-height)] z-40 w-full bg-white/95 backdrop-blur-md border-b border-border shadow-sm mt-12">
          <div className="container py-2 flex items-center justify-between">
            ...
            <div className="flex-1 flex justify-end">
              <Link to="/request-quote/industry" className="hidden sm:inline-block px-4 py-2 bg-primary hover:bg-red-600 text-white font-bold text-xs tracking-wider rounded transition-colors shadow-sm transform hover:-translate-y-0.5 uppercase text-center">
                REQUEST A QUOTE
              </Link>
            </div>
          </div>
