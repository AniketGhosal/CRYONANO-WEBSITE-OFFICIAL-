...
// const iconMap: Record<string, any> = { ThermometerSnowflake, Activity, Zap, Shield, Camera, Move, Waves, Target, Cpu, Settings, Layers, Code, Eye, Droplets, ShieldAlert };
...
// export default function AcDcSystemPageLow() {
//   const product = productsData["ac-dc-system-low"];
//   const [activeSection, setActiveSection] = useState("overview");
//   const [openAccordion, setOpenAccordion] = useState<string | null>("Input Specifications");
