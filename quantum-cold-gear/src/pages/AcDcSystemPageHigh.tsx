...
//   Waves, Layers, Network, Lock, ShieldAlert, ShieldCheck, Code, ArrowLeft, ArrowRight, Move, Wind, Eye, Droplets, Orbit, Image
// } from "lucide-react";
// import { Link } from "react-router-dom";
// import { productsData } from "@/data/products";

// const iconMap: Record<string, any> = { ThermometerSnowflake, Activity, Zap, Shield, Camera, Move, Waves, Target, Cpu, Settings, Layers, Code, Eye, Droplets, ShieldAlert, ShieldCheck, Network, Wind };
...
// export default function AcDcSystemPageHigh() {
...
//               <button className="hidden sm:block px-4 py-2 bg-primary hover:bg-red-600 text-white font-bold text-xs tracking-wider rounded transition-colors shadow-sm transform hover:-translate-y-0.5">
//                 REQUEST PROPOSAL
//               </button>
//             </div>
//           </div>
...
//         {/* 08. VISUAL REFERENCE – SYSTEM IMAGERY (ADDED AS REQUESTED) */}
